...
export default function App() {
  ...
  return <main>
    ...
    <section className="panel agent-panel"><form className="agent-form" onSubmit={submit}>
      ...
      <label>Rövid leírás<textarea value={query} onChange={(e) => setQuery(e.target.value)} onInput={(e)=>{e.currentTarget.style.height="auto";e.currentTarget.style.height=`${Math.min(e.currentTarget.scrollHeight,180)}px`;}} placeholder="anyag, funkció, feldolgozottság, kiszerelés — minél pontosabb, annál biztosabb a besorolás" rows="1" /></label>
      ...
      <p className="defaults-note">Alapértelmezés: mai dátum · 100 000 Ft vámérték · 1 db · B2B · CN (Kína) · harmadik országos vámtétel.</p>
